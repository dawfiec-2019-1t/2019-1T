    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_persona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Persona')),
            ],
        ),
        migrations.CreateModel(
            name='Comentario',
            fields=[
                ...
                ('fecha', models.CharField(max_length=35)),
                ('id_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Voto',
            fields=[
                ...
                ('id_asambleista', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Asambleista')),
                ('id_ley', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Ley')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_comentario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Comentario')),
                ('id_ley', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='govern.Ley')),
            ],
            options={
